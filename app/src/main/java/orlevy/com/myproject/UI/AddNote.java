...
public class AddNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bColor = (Button) findViewById(R.id.button);
        bColor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChooseColor(AddNote.this, Color.RED);
            }
        });
    ...
    private void updateEdit() {
        ...
        view.setBackgroundColor(noteToEDIT.getColor());
    ...
    private void addNewNote() {
        ...
        if (isEdit) {
            handler.editNote(idToEdit, subject.getText().toString(), note.getText().toString(), isStarred, isArchived,color);
        } else {
            handler.addNote(strSubject, strNote, isStarred, isArchived,color);
        }
        if (fromArchived) {
            Intent archived = new Intent(AddNote.this, Archived.class);
            startActivity(archived);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.action_add) {
            ...
            handler.editNote(noteToEDIT.getId(), strSubject, strNote, isStarred, false,color);
    ...
    private void ChooseColor(final Context context, int currentBackgroundColor) {
        ColorPickerDialogBuilder
                ...
                .setOnColorSelectedListener(new OnColorSelectedListener() {
                    ...
                    public void onColorSelected(int selectedColor) {
                        Toast.makeText(context, "Color" + selectedColor, Toast.LENGTH_SHORT).show();
                    }
                })
